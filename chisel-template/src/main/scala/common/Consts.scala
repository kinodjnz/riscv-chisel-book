...
object Consts {
  ...
  val OP2_IM1     = 10.U(OP2_LEN.W)
  val OP2_BFIC    = 14.U(OP2_LEN.W)
  val OP2_BFI     = 15.U(OP2_LEN.W)
  ...
  val OP2_EXTH    = 28.U(OP2_LEN.W)
  val OP2_EXTB    = 29.U(OP2_LEN.W)
  val OP2_X       = 31.U(OP2_LEN.W)
  val OP2_RS2     = 32.U(OP2_LEN.W)
  val OP2_C_RS2   = 36.U(OP2_LEN.W)
  val OP2_C_RS3P  = 37.U(OP2_LEN.W)
  val OP2_C_RS2P  = 38.U(OP2_LEN.W)
  val OP2_C_RS1P  = 39.U(OP2_LEN.W)
