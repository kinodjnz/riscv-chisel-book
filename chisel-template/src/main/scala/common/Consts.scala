...
object Consts {
  ...
  val ALU_ANDN    = 13.U(EXE_FUN_LEN.W)
  val ALU_ORN     = 14.U(EXE_FUN_LEN.W)
  val ALU_XNOR    = 15.U(EXE_FUN_LEN.W)

  val BR_BEQ      = 16.U(EXE_FUN_LEN.W)
  val BR_BNE      = 17.U(EXE_FUN_LEN.W)
  val BR_BLT      = 18.U(EXE_FUN_LEN.W)
  val BR_BGE      = 19.U(EXE_FUN_LEN.W)
  val BR_BLTU     = 20.U(EXE_FUN_LEN.W)
  val BR_BGEU     = 21.U(EXE_FUN_LEN.W)
