...
object Consts {
  ...
  val JB_BLT      =  8.U(EXE_FUN_LEN.W)
  val JB_BEQ      =  9.U(EXE_FUN_LEN.W)
  val JB_BGE      = 10.U(EXE_FUN_LEN.W)

  val PAT_BLT     = BitPat("b1?00")
  val PAT_BEQ     = BitPat("b1?01")
