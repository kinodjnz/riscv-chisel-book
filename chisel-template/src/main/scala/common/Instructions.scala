...
object Instructions {
  ...
  val BFX     = BitPat("b?????10??????????010?????1111011")
  val BFS     = BitPat("b?????10??????????110?????1111011")
  val BFXR    = BitPat("b??????????????????00?????1111011")
  val BFMP    = BitPat("b?????10??????????000?????1110111")
  val BFPP    = BitPat("b?????10??????????001?????1110111")
  val BFMI    = BitPat("b??????????????????10?????1010111")
  val BFPI    = BitPat("b??????????????????11?????1010111")
  val BFXI    = BitPat("b?????10??????????010?????1011011")
  val BFSI    = BitPat("b?????10??????????110?????1011011")
  val BFXRI   = BitPat("b??????????????????00?????1011011")
