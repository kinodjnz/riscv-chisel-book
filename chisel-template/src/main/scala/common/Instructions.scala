...
object Instructions {
  ...
  val BFX     = BitPat("b?????00??????????000?????1111011")
  val BFS     = BitPat("b?????01??????????000?????1111011")
  val BFF     = BitPat("b?????11??????????000?????1111011")
  val BFA     = BitPat("b??????????????????01?????1111011")
  val BFM     = BitPat("b??????????????????10?????1111011")
  val BFP     = BitPat("b??????????????????11?????1111011")
  val BFAP    = BitPat("b?????01??????????100?????1111011")
  val BFMP    = BitPat("b?????10??????????100?????1111011")
  val BFPP    = BitPat("b?????11??????????100?????1111011")
