...
object Instructions {
  ...
  val X_LOAD  = BitPat("b?????????????????????????0000011")
  val SB      = BitPat("b?????????????????000?????0100011")
  val SH      = BitPat("b?????????????????001?????0100011")
  val SW      = BitPat("b?????????????????010?????0100011")
  val X_STORE = BitPat("b?????????????????????????0100011")
  ...
  val BEQI    = BitPat("b???????????????????0?????1110111")
  val BNEI    = BitPat("b???????????????????1?????1110111")
  val BLTI    = BitPat("b?????????????????100?????1111011")
  val BGEI    = BitPat("b?????????????????101?????1111011")
  val BLTIU   = BitPat("b?????????????????110?????1111011")
  val BGEIU   = BitPat("b?????????????????111?????1111011")

  // ジャンプ
  val JUMP    = BitPat("b????????????????????000001101111")
  val CALL    = BitPat("b????????????????????000011101111")
  val RET     = BitPat("b????????????00001000?????1100111")
  ...
  val GORCI   = BitPat("b0010100??????????101?????0010011")
  ...
  val X_SHADD = BitPat("b0010000??????????????????0110011")
  ...
  val BFX     = BitPat("b?????00??????????000?????1010111")
  val BFS     = BitPat("b?????01??????????000?????1010111")
  val BFF     = BitPat("b?????11??????????000?????1010111")
  val BFA     = BitPat("b??????????????????01?????1010111")
  val BFM     = BitPat("b??????????????????10?????1010111")
  val BFP     = BitPat("b??????????????????11?????1010111")
  val BFAP    = BitPat("b?????01??????????100?????1010111")
  val BFMP    = BitPat("b?????10??????????100?????1010111")
  val BFPP    = BitPat("b?????11??????????100?????1010111")
  val BFXI    = BitPat("b?????00??????????000?????1011011")
  val BFSI    = BitPat("b?????01??????????000?????1011011")
  val BFFI    = BitPat("b?????11??????????000?????1011011")
  val BFAI    = BitPat("b??????????????????01?????1011011")
  val BFMI    = BitPat("b??????????????????10?????1011011")
  val BFPI    = BitPat("b??????????????????11?????1011011")
  val X_BF    = BitPat("b?????????????????????????1010111")
  val X_BFI   = BitPat("b?????????????????????????1011011")
  val X_ZBT   = BitPat("b?????1???????????????????0110011")
  val X_ZBTI  = BitPat("b?????1???????????????????0010011")
  ...
  val C_RET      = BitPat("b????????????????1000000010000010")
  ...
  val C_MULH     = BitPat("b????????????????100111???00???01")
  val C_MULHU    = BitPat("b????????????????100111???01???01")
  ...
  val C_1OP_ALU1 = BitPat("b????????????????100111???1110001")
  val C_NOT      = BitPat("b????????????????100111???1110101")
  val C_NEG      = BitPat("b????????????????100111???1111001")
  val C_1OP_ALU2 = BitPat("b????????????????100111???1111101")
