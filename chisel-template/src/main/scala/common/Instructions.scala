...
object Instructions {
  ...
  val BFM     = BitPat("b??????????????????10?????1110111")
  val BFP     = BitPat("b??????????????????11?????1110111")
  val BFX     = BitPat("b??????????????????10?????1111011")
  val BFS     = BitPat("b00000?????????????11?????1111011")
  val BFMP    = BitPat("b?????10??????????000?????1110111")
  val BFPP    = BitPat("b?????10??????????001?????1110111")
  val BFXP    = BitPat("b?????10??????????000?????1111011")
  val BFSP    = BitPat("b0000010??????????001?????1111011")
  val BFMI    = BitPat("b??????????????????10?????1010111")
  val BFPI    = BitPat("b??????????????????11?????1010111")
  val BFXI    = BitPat("b??????????????????10?????1011011")
  val BFSI    = BitPat("b00000?????????????11?????1011011")
