...
class Core(
  ...
  when ((ex1_reg_i2_rf_wen === REN_S && (!reg_flush && !ex2_reg_stall)) || lsu.io.out.wb_en) {
  ...
  when (ex2_reg_rf_wen === REN_S && !(ex1_reg_i2_rf_wen === REN_S && (!reg_flush && !ex2_reg_stall) && (ex1_reg_i2_wb_addr === ex2_reg_wb_addr))) {
