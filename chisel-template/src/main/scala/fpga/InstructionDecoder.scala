...
class InstructionDecoder(
  ...
  val csignals = ListLookup(id_inst,
    ...
    Array(
      ...
      SEXTB      -> List(ALU_BFX    , OP1_RS1   , OP2_EXTB    , OP3_X     , REN_S, WB_BIT  , WBA_RD , CSR_X, MW_X  , OP2OP_SEXT),
      SEXTH      -> List(ALU_BFX    , OP1_RS1   , OP2_EXTH    , OP3_X     , REN_S, WB_BIT  , WBA_RD , CSR_X, MW_X  , OP2OP_SEXT),
      ZEXTH      -> List(ALU_BFX    , OP1_RS1   , OP2_EXTH    , OP3_Z     , REN_S, WB_BIT  , WBA_RD , CSR_X, MW_X  , OP2OP_NOP),
      ...
      C_SEXTB    -> List(ALU_BFX    , OP1_C_RS1P, OP2_EXTB    , OP3_X     , REN_S, WB_BIT  , WBA_CP1, CSR_X, MW_X  , OP2OP_SEXT),
      C_SEXTH    -> List(ALU_BFX    , OP1_C_RS1P, OP2_EXTH    , OP3_X     , REN_S, WB_BIT  , WBA_CP1, CSR_X, MW_X  , OP2OP_SEXT),
      C_ZEXTH    -> List(ALU_BFX    , OP1_C_RS1P, OP2_EXTH    , OP3_Z     , REN_S, WB_BIT  , WBA_CP1, CSR_X, MW_X  , OP2OP_NOP),
  ...
  id_op2_data_im1 := MuxCase(DontCare, Seq(
    ...
    (id_op2_sel === OP2_IM255)   -> 0.U(WORD_LEN.W),
