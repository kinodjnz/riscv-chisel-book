...
class InstructionDecoder(
  ...
  val csignals = ListLookup(id_inst,
    ...
    Array(
      ...
      SLT        -> List(ALU_SLT   , OP1_RS1   , OP2_RS2     , OP3_X     , REN_S, WB_ALU  , WBA_RD , CSR_X, MW_X  , OP2OP_SIGNED),
      SLTU       -> List(ALU_SLT   , OP1_RS1   , OP2_RS2     , OP3_X     , REN_S, WB_ALU  , WBA_RD , CSR_X, MW_X  , OP2OP_UNSIGNED),
      SLTI       -> List(ALU_SLT   , OP1_RS1   , OP2_IMI     , OP3_X     , REN_S, WB_ALU  , WBA_RD , CSR_X, MW_X  , OP2OP_SIGNED),
      SLTIU      -> List(ALU_SLT   , OP1_RS1   , OP2_IMI     , OP3_X     , REN_S, WB_ALU  , WBA_RD , CSR_X, MW_X  , OP2OP_UNSIGNED),
      ...
      MAX        -> List(ALU_MAX   , OP1_RS1   , OP2_RS2     , OP3_X     , REN_S, WB_ALU  , WBA_RD , CSR_X, MW_X  , OP2OP_SIGNED),
      MAXU       -> List(ALU_MAX   , OP1_RS1   , OP2_RS2     , OP3_X     , REN_S, WB_ALU  , WBA_RD , CSR_X, MW_X  , OP2OP_UNSIGNED),
      MIN        -> List(ALU_MIN   , OP1_RS1   , OP2_RS2     , OP3_X     , REN_S, WB_ALU  , WBA_RD , CSR_X, MW_X  , OP2OP_SIGNED),
      MINU       -> List(ALU_MIN   , OP1_RS1   , OP2_RS2     , OP3_X     , REN_S, WB_ALU  , WBA_RD , CSR_X, MW_X  , OP2OP_UNSIGNED),
      ...
      SEXTB      -> List(ALU_SZEXT , OP1_RS1   , OP2_EXTB    , OP3_X     , REN_S, WB_ALU  , WBA_RD , CSR_X, MW_X  , OP2OP_SEXT),
      SEXTH      -> List(ALU_SZEXT , OP1_RS1   , OP2_EXTH    , OP3_X     , REN_S, WB_ALU  , WBA_RD , CSR_X, MW_X  , OP2OP_SEXT),
      ZEXTH      -> List(ALU_SZEXT , OP1_RS1   , OP2_EXTH    , OP3_X     , REN_S, WB_ALU  , WBA_RD , CSR_X, MW_X  , OP2OP_NOP),
      ...
      BFX        -> List(ALU_BFX   , OP1_RS1   , OP2_RS2BFL  , OP3_RS3   , REN_S, WB_BIT  , WBA_RD , CSR_X, MW_X  , OP2OP_NOP),
      BFS        -> List(ALU_BFX   , OP1_RS1   , OP2_RS2BFL  , OP3_X     , REN_S, WB_BIT  , WBA_RD , CSR_X, MW_X  , OP2OP_SEXT),
      ...
      BFXP       -> List(ALU_BFX   , OP1_RS1   , OP2_RS2     , OP3_RS3   , REN_S, WB_BIT  , WBA_RD , CSR_X, MW_X  , OP2OP_NOP),
      BFSP       -> List(ALU_BFX   , OP1_RS1   , OP2_RS2     , OP3_X     , REN_S, WB_BIT  , WBA_RD , CSR_X, MW_X  , OP2OP_SEXT),
      ...
      BFXI       -> List(ALU_BFX   , OP1_RS1   , OP2_BFI     , OP3_RS3   , REN_S, WB_BIT  , WBA_RD , CSR_X, MW_X  , OP2OP_NOP),
      ...
      C_ZEXTB    -> List(ALU_SZEXT , OP1_C_RS1P, OP2_EXTB    , OP3_X     , REN_S, WB_ALU  , WBA_CP1, CSR_X, MW_X  , OP2OP_NOP),
      C_SEXTB    -> List(ALU_SZEXT , OP1_C_RS1P, OP2_EXTB    , OP3_X     , REN_S, WB_ALU  , WBA_CP1, CSR_X, MW_X  , OP2OP_SEXT),
      C_ZEXTH    -> List(ALU_SZEXT , OP1_C_RS1P, OP2_EXTH    , OP3_X     , REN_S, WB_ALU  , WBA_CP1, CSR_X, MW_X  , OP2OP_NOP),
      C_SEXTH    -> List(ALU_SZEXT , OP1_C_RS1P, OP2_EXTH    , OP3_X     , REN_S, WB_ALU  , WBA_CP1, CSR_X, MW_X  , OP2OP_SEXT),
      ...
      C_SEQZ     -> List(ALU_SLT   , OP1_C_RS1P, OP2_IM1     , OP3_X     , REN_S, WB_ALU  , WBA_CP2, CSR_X, MW_X  , OP2OP_UNSIGNED),
      C_SNEZ     -> List(ALU_SLT   , OP1_Z     , OP2_C_RS1P  , OP3_X     , REN_S, WB_ALU  , WBA_CP2, CSR_X, MW_X  , OP2OP_UNSIGNED),
      C_ADDI2B   -> List(ALU_ADD   , OP1_C_RS1P, OP2_C_IMA2B , OP3_X     , REN_S, WB_ALU  , WBA_CP2, CSR_X, MW_X  , OP2OP_NOP),
      C_SLT      -> List(ALU_SLT   , OP1_C_RS1P, OP2_C_RS3P  , OP3_X     , REN_S, WB_ALU  , WBA_CP2, CSR_X, MW_X  , OP2OP_SIGNED),
      C_SLTU     -> List(ALU_SLT   , OP1_C_RS1P, OP2_C_RS3P  , OP3_X     , REN_S, WB_ALU  , WBA_CP2, CSR_X, MW_X  , OP2OP_UNSIGNED),
		)
	)
  ...
  id_op2_data_im1 := MuxCase(DontCare, Seq(
    ...
    //
    (id_op2_sel === OP2_C_IMIW)  -> 0.U(WORD_LEN.W),
    (id_op2_sel === OP2_C_IMLS)  -> 0.U(WORD_LEN.W),
    (id_op2_sel === OP2_C_IMSL)  -> 0.U(WORD_LEN.W),
    (id_op2_sel === OP2_C_IMSS)  -> 0.U(WORD_LEN.W),
    (id_op2_sel === OP2_C_IMLSB) -> 0.U(WORD_LEN.W),
    (id_op2_sel === OP2_C_IMLSH) -> 0.U(WORD_LEN.W),
    (id_op2_sel === OP2_C_IMSW0) -> 0.U(WORD_LEN.W),
    ...
    //
    (id_op2_sel === OP2_RS2)     -> 0.U(WORD_LEN.W),
    // (id_op2_sel === OP2_C_RS2)   -> 0.U(WORD_LEN.W),
    // (id_op2_sel === OP2_C_RS3P)  -> 0.U(WORD_LEN.W),
    // (id_op2_sel === OP2_C_RS2P)  -> 0.U(WORD_LEN.W),
    // (id_op2_sel === OP2_C_RS1P)  -> 0.U(WORD_LEN.W),
  ))
  val id_op2_data_im0 = Wire(UInt(12.W))
  id_op2_data_im0 := MuxCase(DontCare, Seq(
    (id_op2_sel === OP2_Z)       -> 0.U(12.W),
    (id_op2_sel === OP2_IMI)     -> 0.U(12.W),
    (id_op2_sel === OP2_IMS)     -> 0.U(12.W),
    (id_op2_sel === OP2_IMJ)     -> 0.U(12.W),
    (id_op2_sel === OP2_IMU)     -> 0.U(12.W),
    (id_op2_sel === OP2_C_IMI16) -> 0.U(12.W),
    (id_op2_sel === OP2_C_IMI)   -> 0.U(12.W),
    (id_op2_sel === OP2_C_IMIU)  -> 0.U(12.W),
    (id_op2_sel === OP2_C_IMJ)   -> 0.U(12.W),
    (id_op2_sel === OP2_IMALL1)  -> 0.U(12.W),
    (id_op2_sel === OP2_C_IMA2W) -> 0.U(12.W),
    (id_op2_sel === OP2_C_IMA2B) -> 0.U(12.W),
    (id_op2_sel === OP2_C_IMU)   -> 0.U(12.W),
    //
    ...
    // (id_op2_sel === OP2_C_RS3P)  -> 0.U(12.W),
    // (id_op2_sel === OP2_C_RS2P)  -> 0.U(12.W),
  ...
  io.out.bits.op2_data_im1  := id_output_queue.io.deq.bits.op2_data_im1
  io.out.bits.op2_data_im0  := id_output_queue.io.deq.bits.op2_data_im0
