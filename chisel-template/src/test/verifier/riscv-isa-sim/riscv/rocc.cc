...
std::vector<insn_desc_t> rocc_t::get_instructions(const processor_t &)
{
  std::vector<insn_desc_t> insns = {
    {0x0b, 0x7f, 0, &::illegal_instruction, c0, &::illegal_instruction, c0, &::illegal_instruction, c0, &::illegal_instruction, c0},
    {0x2b, 0x7f, 0, &::illegal_instruction, c1, &::illegal_instruction, c1, &::illegal_instruction, c1, &::illegal_instruction, c1},
    {0x5b, 0x7f, 0, &::illegal_instruction, c2, &::illegal_instruction, c2, &::illegal_instruction, c2, &::illegal_instruction, c2},
    {0x7b, 0x7f, 0, &::illegal_instruction, c3, &::illegal_instruction, c3, &::illegal_instruction, c0, &::illegal_instruction, c3}};
  return insns;
}
