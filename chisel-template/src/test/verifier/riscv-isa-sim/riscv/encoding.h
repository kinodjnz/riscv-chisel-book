...
#define MATCH_C_BEQ 0x8000
#define MASK_C_BEQ 0xe003
#define MATCH_C_BNE 0xa000
#define MASK_C_BNE 0xe003
#define MATCH_C_AUIPC 0xe000
#define MASK_C_AUIPC 0xe003
#define MATCH_C_MULH 0x9c01
#define MASK_C_MULH 0xfc63
#define MATCH_C_MULHU 0x9c21
#define MASK_C_MULHU 0xfc63
#define MATCH_C_NEG 0x9c79
#define MASK_C_NEG 0xfc7f
#define MATCH_C_ADDI2W 0xa002
#define MASK_C_ADDI2W 0xe003
#define MATCH_C_ADD2 0xe002
#define MASK_C_ADD2 0xe063
#define MATCH_C_SEQZ 0xe022
#define MASK_C_SEQZ 0xfc63
#define MATCH_C_SNEZ 0xf022
#define MASK_C_SNEZ 0xfc63
#define MATCH_C_ADDI2B 0xe022
#define MASK_C_ADDI2B 0xe063
#define MATCH_C_SLT 0xe042
#define MASK_C_SLT 0xe063
#define MATCH_C_SLTU 0xe062
#define MASK_C_SLTU 0xe063
#define MATCH_C_LB 0x2000
#define MASK_C_LB 0xe003
#define MATCH_C_LBU 0x6000
#define MASK_C_LBU 0xe003
#define MATCH_C_LH 0x2002
#define MASK_C_LH 0xf803
#define MATCH_C_LHU 0x2802
#define MASK_C_LHU 0xf803
#define MATCH_C_SB 0x6002
#define MASK_C_SB 0xe003
#define MATCH_C_SH 0x3002
#define MASK_C_SH 0xf803
#define MATCH_C_SB0 0x3806
#define MASK_C_SB0 0xf80f
#define MATCH_C_SH0 0x380e
#define MASK_C_SH0 0xf80f
#define MATCH_C_SW0 0x3802
#define MASK_C_SW0 0xf807
#define MATCH_CMOV 0x06005033
#define MASK_CMOV 0x0600707f
#define MATCH_FSL 0x04001033
#define MASK_FSL 0x0600707f
#define MATCH_FSR 0x04005033
#define MASK_FSR 0x0600707f
#define MATCH_FSRI 0x04005013
#define MASK_FSRI 0x0600707f
#define MATCH_BFX 0x57
#define MASK_BFX 0x0600707f
#define MATCH_BFS 0x02000057
#define MASK_BFS 0x0600707f
#define MATCH_BFF 0x06000057
#define MASK_BFF 0x0600707f
#define MATCH_BFA 0x1057
#define MASK_BFA 0x307f
#define MATCH_BFM 0x2057
#define MASK_BFM 0x307f
#define MATCH_BFP 0x3057
#define MASK_BFP 0x307f
#define MATCH_BFAP 0x02004057
#define MASK_BFAP 0x0600707f
#define MATCH_BFMP 0x04004057
#define MASK_BFMP 0x0600707f
#define MATCH_BFPP 0x06004057
#define MASK_BFPP 0x0600707f
#define MATCH_BFXI 0x5b
#define MASK_BFXI 0x0600707f
#define MATCH_BFSI 0x0200005b
#define MASK_BFSI 0x0600707f
#define MATCH_BFFI 0x0600005b
#define MASK_BFFI 0x0600707f
#define MATCH_BFAI 0x105b
#define MASK_BFAI 0x307f
#define MATCH_BFMI 0x205b
#define MASK_BFMI 0x307f
#define MATCH_BFPI 0x305b
#define MASK_BFPI 0x307f
#define MATCH_BSCT_H 0x4a001033
#define MASK_BSCT_H 0xfe00707f
#define MATCH_SEQ 0x70002033
#define MASK_SEQ 0xfe00707f
#define MATCH_SNE 0x70003033
#define MASK_SNE 0xfe00707f
#define MATCH_SEQI 0x601b
#define MASK_SEQI 0x707f
#define MATCH_SNEI 0x701b
#define MASK_SNEI 0x707f
#define MATCH_BEQI 0x77
#define MASK_BEQI 0x107f
#define MATCH_BNEI 0x1077
#define MASK_BNEI 0x107f
#define MATCH_BGEI 0x507b
#define MASK_BGEI 0x707f
#define MATCH_BGEIU 0x707b
#define MASK_BGEIU 0x707f
#define MATCH_BLTI 0x407b
#define MASK_BLTI 0x707f
#define MATCH_BLTIU 0x607b
#define MASK_BLTIU 0x707f
...
DECLARE_INSN(c_auipc, MATCH_C_AUIPC, MASK_C_AUIPC)
DECLARE_INSN(c_mulh, MATCH_C_MULH, MASK_C_MULH)
DECLARE_INSN(c_mulhu, MATCH_C_MULHU, MASK_C_MULHU)
DECLARE_INSN(c_neg, MATCH_C_NEG, MASK_C_NEG)
DECLARE_INSN(c_addi2w, MATCH_C_ADDI2W, MASK_C_ADDI2W)
DECLARE_INSN(c_add2, MATCH_C_ADD2, MASK_C_ADD2)
DECLARE_INSN(c_seqz, MATCH_C_SEQZ, MASK_C_SEQZ)
DECLARE_INSN(c_snez, MATCH_C_SNEZ, MASK_C_SNEZ)
DECLARE_INSN(c_addi2b, MATCH_C_ADDI2B, MASK_C_ADDI2B)
...
DECLARE_INSN(c_sb0, MATCH_C_SB0, MASK_C_SB0)
DECLARE_INSN(c_sh0, MATCH_C_SH0, MASK_C_SH0)
DECLARE_INSN(c_sw0, MATCH_C_SW0, MASK_C_SW0)
...
DECLARE_INSN(bfx, MATCH_BFX, MASK_BFX)
DECLARE_INSN(bfs, MATCH_BFS, MASK_BFS)
DECLARE_INSN(bff, MATCH_BFF, MASK_BFF)
DECLARE_INSN(bfa, MATCH_BFA, MASK_BFA)
DECLARE_INSN(bfm, MATCH_BFM, MASK_BFM)
DECLARE_INSN(bfp, MATCH_BFP, MASK_BFP)
DECLARE_INSN(bfap, MATCH_BFAP, MASK_BFAP)
DECLARE_INSN(bfmp, MATCH_BFMP, MASK_BFMP)
DECLARE_INSN(bfpp, MATCH_BFPP, MASK_BFPP)
DECLARE_INSN(bfxi, MATCH_BFXI, MASK_BFXI)
DECLARE_INSN(bfsi, MATCH_BFSI, MASK_BFSI)
DECLARE_INSN(bffi, MATCH_BFFI, MASK_BFFI)
DECLARE_INSN(bfai, MATCH_BFAI, MASK_BFAI)
DECLARE_INSN(bfmi, MATCH_BFMI, MASK_BFMI)
DECLARE_INSN(bfpi, MATCH_BFPI, MASK_BFPI)
DECLARE_INSN(bsct_h, MATCH_BSCT_H, MASK_BSCT_H)
DECLARE_INSN(seq, MATCH_SEQ, MASK_SEQ)
DECLARE_INSN(sne, MATCH_SNE, MASK_SNE)
DECLARE_INSN(seqi, MATCH_SEQI, MASK_SEQI)
DECLARE_INSN(snei, MATCH_SNEI, MASK_SNEI)
DECLARE_INSN(beqi, MATCH_BEQI, MASK_BEQI)
DECLARE_INSN(bnei, MATCH_BNEI, MASK_BNEI)
DECLARE_INSN(blti, MATCH_BLTI, MASK_BLTI)
DECLARE_INSN(bgei, MATCH_BGEI, MASK_BGEI)
DECLARE_INSN(bltiu, MATCH_BLTIU, MASK_BLTIU)
DECLARE_INSN(bgeiu, MATCH_BGEIU, MASK_BGEIU)
#endif
#ifdef DECLARE_CSR
