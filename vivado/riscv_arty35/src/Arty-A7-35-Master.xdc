...
connect_debug_port u_ila_0/clk [get_nets [list user_design_clk]]
connect_debug_port dbg_hub/clk [get_nets user_design_clk]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {io_debugSignals_mem_dram_state[0]} {io_debugSignals_mem_dram_state[1]} {io_debugSignals_mem_dram_state[2]}]]
